...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":Lets Generator", anchor=N, fg='black', bg='purple', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='red', fg='black')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='Cyan', fg='black')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='indigo', fg='black')
